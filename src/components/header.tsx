    ...
    <header>
      ...
      <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image
            ...
            priority
          />
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Meal Store</span>
      </a>
      ...
      <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          ...
          {navLinks.map((link) => (
              <li key={link.href}>
              <Link
                  className={`${`block py-2 px-3 text-white ${pathname === link.href ? "text-zinc-900" : "text-zinc-400"} rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500`}`}
